...
\begin{dtuposterhead} %
\dtuposterauthor{Mads Andersen, Oskar Christensen, Anders Henriksen, Søren Holm, Asger Schultz}
\dtuposteraffil{DTU Compute}
\dtuposteraffil{\texttt{\{s183911, s183912\}@student.dtu.dk}}
\end{dtuposterhead}
%
%
%======================================================================
...
\subfloat{
\includegraphics[width=.5\linewidth]{forward}	
}
