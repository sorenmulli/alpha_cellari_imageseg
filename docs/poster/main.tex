...
\\
\\
\indent On this poster, you can expect to learn about the implementation of SegNet for pixelwise crop classification on a drone image. The results of this implementation is also shown as well as the problems with such data and what can be done to improve it for future implementations.
...
\begin{itemize}
	...
	\item Can lead to an algorithm that can identify crops and weed on a field and aid farmers in their work. 
\end{itemize}
